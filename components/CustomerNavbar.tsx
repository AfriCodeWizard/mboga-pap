    ...
    <nav className="bg-white shadow-lg border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Logo Container - Independent and Fixed */}
          ...
          {/* Right side items - Independent */}
          <div className="flex items-center space-x-4 flex-shrink-0" style={{ minWidth: '180px', justifyContent: 'flex-end' }}>
            {/* Loyalty Points */}
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative h-8 w-8 rounded-full min-w-[32px]">

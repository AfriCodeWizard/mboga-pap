...
export default function VendorResourcesPage() {
  return (
    <>
      <Head>
        <title>Vendor Resources | Mbonga Pap!</title>
        <meta name="description" content="Everything you need to succeed as a MamaMboga on Mbonga Pap! Guides, payments, marketing tips, and community support." />
        <meta property="og:title" content="Vendor Resources | Mbonga Pap!" />
        <meta property="og:description" content="Everything you need to succeed as a MamaMboga on Mbonga Pap! Guides, payments, marketing tips, and community support." />
        ...
        <meta name="twitter:title" content="Vendor Resources | Mbonga Pap!" />
        <meta name="twitter:description" content="Everything you need to succeed as a MamaMboga on Mbonga Pap! Guides, payments, marketing tips, and community support." />
      </Head>

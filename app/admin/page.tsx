                      ...
                      <CardContent className="p-2 sm:p-6 w-full">
                        <div className="overflow-x-auto w-full">
                          <table className="w-full text-xs sm:text-sm">
                            ...
                            <tbody>
                              {[
                                { date: "2024-01-16", user: "Mama Grace Wanjiku", type: "Vendor", amount: "KSh 8,750", status: "Pending", ref: "PAY-001" },
                                ...
                                { date: "2024-01-14", user: "Mama Grace Wanjiku", type: "Vendor", amount: "KSh 4,000", status: "Paid", ref: "PAY-000" },
                              ].map((tx) => (
                                <tr key={tx.ref}>
